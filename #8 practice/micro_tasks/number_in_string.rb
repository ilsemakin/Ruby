...
def hash
  h = { 1 => :one, 2 => :two, 3 => :three, 4 => :four, 5 => :five,
        ...
        51 => :fifty_one, 52 => :fifty_two, 53 => :fifty_three, 54 => :fifty_four, 55 => :thirty_five,
        ...
        81 => :eighty_one, 82 => :eighty_two, 83 => :eighty_three, 84 => :eighty_four, 85 => :thirty_five,
        ...
        96 => :ninety_six, 97 => :ninety_seven, 98 => :ninety_eight, 99 => :ninety_nine, 100 => :hundred }
  h
end
...
def command
  ...
  number = ARGV[0]
  hash.each { |index, command| return command if Integer(number) == index }

  puts 'Unknown number! [1 .. 100]'
